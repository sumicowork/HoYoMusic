...
-- 5. Insert default tag groups (using English names first, can be updated via UI)
INSERT INTO tag_groups (name, description, icon, display_order) VALUES
  ('Game Categories', 'Tags for game series classification', 'GamepadOutlined', 1),
  ('Music Styles', 'Music style and genre tags', 'SoundOutlined', 2),
  ('Languages', 'Song language tags', 'GlobalOutlined', 3),
  ('Emotions', 'Music emotion and atmosphere tags', 'HeartOutlined', 4),
  ('Scenarios', 'Applicable scenario tags', 'EnvironmentOutlined', 5),
  ('Others', 'Other classification tags', 'TagsOutlined', 99)
